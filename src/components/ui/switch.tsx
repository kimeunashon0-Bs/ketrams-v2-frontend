...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      // Checked state: primary background, transparent border
      "data-[state=checked]:bg-primary data-[state=checked]:border-transparent",
      // Unchecked state: light background + black border
      "data-[state=unchecked]:bg-input data-[state=unchecked]:border-black",
      className
    )}
    {...props}
    ref={ref}
